...
<template>
  <div class="email-car-bg-color fixed top-0 left-0 w-full h-16 pl-10 pr-10 z-20 flex justify-between items-center">
    ...
    <div class="group relative">
      ...
      <ul class="ml-auto absolute top-0 text-center right-3 w-40 scale-0 group-hover:scale-100 duration-500 origin-top-right email-car-bg-color m-5 rounded-lg">
        <li class="py-2 hover:cursor-pointer" @click="onNavClick('/email')">邮箱</li>
  ...
  <div class="email-car-bg-color shadow-xl rounded-md clear-both p-5 mx-10 my-10 home-footer py-5 text-center">
    ...
    <!-- 给我这个网站给个说明 -->
    <div class="text-sm my-5">这是一个基于Vue3.x的个人网站，主要用于记录平时学习的心得体会，分享一些个人项目，以及一些技术文章。</div>
    <div class="icon-list flex justify-center items-center my-5">
      <!-- <a title="打赏站长" target="_blank" href="/images/reward.webp"></a> -->
      <a class="icon-item inline-block w-8 h-8 mr-5" title="添加群聊" target="_blank" rel="nofollow" href="https://qm.qq.com/q/tX8dU3hBu0"></a>
      <a class="icon-item inline-block w-8 h-8 mr-5" title="Github" target="_blank" rel="nofollow" href="https://github.com/HmanCode8"></a>
