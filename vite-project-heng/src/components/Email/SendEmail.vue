...
const handleSendEmail = () => {
  ...
  const recipientName = _.get(_.find(props.users,{'_id': serderValue.value}),'username')
  const params = {
...
<template>
  <div class="content-user-input flex flex-col h-3/4 p-5 w-full">
    ...
    <div class="send-btn flex">
      <el-button type="success" plain class="mt-3" @click="handleSendEmail">发送</el-button>
    ...
    <div class="flex items-center">
      ...
      <el-select class="pt-3 pb-3 w-full" v-model="serderValue" clearable placeholder="请选择">
